...
class BinarySearchTree:
    ...
    def Search1d(self, x_value, y_value):
        ...
        if x_node is not None:
            print(f"Displaying subtree starting from {x_value}:")
            self.display(x_node)  # Display the subtree starting from x_node
        else:
            print(f"{x_value} not found in the tree.")

        if y_node is not None:
            print(f"Displaying subtree starting from {y_value}:")
            self.display(y_node)  # Display the subtree up to y_node
        else:
